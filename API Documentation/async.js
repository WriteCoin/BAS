 ...
 * @param {number} thread_id ID потока
  ...
  Примеры :
  [[THREAD_ID]] - Ждать завершения одной функции.
  [[THREAD_LIST]] - Ждать завершения всех функций в списке.
