...
*/
const BAS_popup_close = async (index, callback) => await f("BAS_popup_close", { index, callback })
...
* @param callback
*/
const BAS_load = async (text, referrer, is_instant, callback) => await f("BAS_load", { text, referrer, is_instant, callback })
...
*/
const BAS_general_timeout_next = async (timeout) => await f("BAS_general_timeout_next", { timeout })
...
*/
const BAS_general_timeout = async (timeout) => await f("BAS_general_timeout", { timeout })

	/**
* @param timeout Таймаут в миллисекундах
*/
const BAS_async_load_timeout = async (timeout) => await f("BAS_async_load_timeout", { timeout })

	/**
* Изменить максимальное время решения капчи
* @param timeout Таймаут в миллисекундах
*/
const BAS_solver_timeout = async (timeout) => await f("BAS_solver_timeout", { timeout })
...
*/
const BAS_url = async (params) => await f("BAS_url", params || {})
...
*/
const BAS_navigate_back = async (is_instant, timeout, callback) => await f("BAS_navigate_back", { is_instant, timeout, callback })
...
*/
const BAS_type = async (text, interval, is_instant, timeout) => await f("BAS_type", { text, interval, is_instant, timeout })
...
* @param callback Функция
*/
const BAS_resize = async (x, y, callback) => await f("BAS_resize", { x, y, callback })
...
*/
const BAS_get_browser_screen_settings = async (params) => await f("BAS_get_browser_screen_settings", params || {})
...
*/
const BAS_new_browser = async (callback) => await f("BAS_new_browser", { callback })
...
* @param callback функция
*/
const BAS_open_file_dialog = async (text, callback) => await f("BAS_open_file_dialog", { text, callback })
...
* @param callback функция
*/
const BAS_drag_file = async (text, callback) => await f("BAS_drag_file", { text, callback })
...
* @param callback функция
*/
const BAS_prompt_result = async (text, callback) => await f("BAS_prompt_result", { text, callback })
...
* @param callback функция
*/
const BAS_http_auth_result = async (login, pass, callback) => await f("BAS_http_auth_result", { login, pass, callback })
...
* @param callback функция
*/
const BAS_scroll_to = async (target, callback) => await f("BAS_scroll_to", { target, callback })
...
* @param callback функция
*/
const BAS_recaptcha_v3 = async (params) => await f("BAS_recaptcha_v3", params || {})
...
*/
const BAS_solver_failed = async (params) => await f("BAS_solver_failed", params || {})
...
* @param callback Функция
*/
const BAS_click_extension_button = async (id, is_instant, timeout, callback) => await f("BAS_click_extension_button", { id, is_instant, timeout, callback })
...
* @param callback Функция
*/
const BAS_browser_mode = async (mode, callback) => await f("BAS_browser_mode", { mode, callback })
...
*/
const BAS_default_move_params = async (params) => await f("BAS_default_move_params", params || {})
...
* @param callback Функция
*/
const BAS_enable_notifications = async (enable, callback) => await f("BAS_enable_notifications", { enable, callback })
...
*/
const BAS_open_browser = async (params) => await f("BAS_open_browser", params || {})
...
* Очень важно понять, что по умолчанию браузер создается автоматически, и вам не нужно вызывать действие 'Открыть браузер', если только не требуется контролировать время работы браузера вручную.
*/
const BAS_close_browser = async (params) => await f("BAS_close_browser", params || {})
...
*/
const get_html_script = async (element) => await f("get_html_script", { element })
...
*/
const BAS_javascript = async (script) => await f("BAS_javascript", { script })
...
*/
const BAS_onLoadJavascript = async (script, url, tab) => await f("BAS_onLoadJavascript", { script, url, tab })
