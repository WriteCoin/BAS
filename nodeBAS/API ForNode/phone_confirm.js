const get_phone_confirm_functions = (f) => {
	/**
...
*/
const BAS_phone_set_debug = async (enable) => await f("BAS_phone_set_debug", { enable })

return {	BAS_phone_get_number,
...
module.exports = get_phone_confirm_functions