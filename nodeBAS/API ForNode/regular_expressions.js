const get_regular_expressions_functions = (f) => {
	/**
* Первое вхождение
...
* }
*/
const BAS_regexp_first = async (text, regexp) => await f("BAS_regexp_first", { text, regexp })
...
*/
const BAS_regexp_scan = async (text, regexp) => await f("BAS_regexp_scan", { text, regexp })
...
*/
const BAS_regexp_is_match = async (text, regexp) => await f("BAS_regexp_is_match", { text, regexp })
...
*/
const BAS_regexp_split = async (text, regexp) => await f("BAS_regexp_split", { text, regexp })
...
*/
const BAS_regexp_replace = async (text, regexp, replace) => await f("BAS_regexp_replace", { text, regexp, replace })

return {	BAS_regexp_first,
	BAS_regexp_scan,
	BAS_regexp_is_match,
	BAS_regexp_split,
	BAS_regexp_replace,
...
module.exports = get_regular_expressions_functions