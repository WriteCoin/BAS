const get_http_client_functions = (f) => {
	/**
* HTTP-Клиент Прокси
...
*/
const BAS_http_client_set_proxy = async (proxy, proxy_type, login, password) => await f("BAS_http_client_set_proxy", { proxy, proxy_type, login, password })
...
*/
const BAS_http_client_encoded_content = async (encoding) => await f("BAS_http_client_encoded_content", { encoding })
...
*/
const BAS_http_client_header = async (header) => await f("BAS_http_client_header", { header })
...
*/
const BAS_http_client_set_header = async (header_name, header_value) => await f("BAS_http_client_set_header", { header_name, header_value })
...
*/
const BAS_http_client_restore_cookies = async (cookies) => await f("BAS_http_client_restore_cookies", { cookies })
...
* Завершать работу после ошибки
*/
const BAS_http_client_set_fail_on_error = async (fail_on_error) => await f("BAS_http_client_set_fail_on_error", { fail_on_error })
...
*/
const BAS_http_client_xpath_xml = async (query, do_not_fail) => await f("BAS_http_client_xpath_xml", { query, do_not_fail })
...
*/
const BAS_http_client_xpath_xml_list = async (query, do_not_fail) => await f("BAS_http_client_xpath_xml_list", { query, do_not_fail })
...
*/
const BAS_http_client_xpath_text = async (query, do_not_fail) => await f("BAS_http_client_xpath_text", { query, do_not_fail })
...
*/
const BAS_http_client_xpath_text_list = async (query, do_not_fail) => await f("BAS_http_client_xpath_text_list", { query, do_not_fail })
...
*/
const BAS_http_client_xpath_count = async (query, do_not_fail) => await f("BAS_http_client_xpath_count", { query, do_not_fail })
...
*/
const BAS_http_client_xpath_exists = async (query) => await f("BAS_http_client_xpath_exists", { query })

return {	BAS_http_client_set_proxy,
...
module.exports = get_http_client_functions