...
&googlekey=6LfZil0UAAAAAAdm1Dpzsw9q0F11-bmervx9g5fE&pageurl=http://mysite.com/page
*/
const BAS_url_normalize = async (url, params) => await f("BAS_url_normalize", { url, params })
...
* }
*/
const BAS_url_parse = async (url, normalize, base_url, rfail) => await f("BAS_url_parse", { url, normalize, base_url, rfail })
...
&googlekey=6LfZil0UAAAAAAdm1Dpzsw9q0F11-bmervx9g5fE&pageurl=http://mysite.com/page
*/
const BAS_change_url = async (url, params) => await f("BAS_change_url", { url, params })
...
* }
*/
const BAS_parse_user_agent = async (user_agent) => await f("BAS_parse_user_agent", { user_agent })
...
*/
const BAS_url_punycode = async (str, encode) => await f("BAS_url_punycode", { str, encode })
...
* @returns закодированная строка в случае использования режима encode и результат декодирования при использовании режима decode.
*/
const BAS_url_component = async (str, encode) => await f("BAS_url_component", { str, encode })

return {	BAS_url_normalize,
	BAS_url_parse,
	BAS_generate_url,
	BAS_change_url,
...
module.exports = get_url_functions