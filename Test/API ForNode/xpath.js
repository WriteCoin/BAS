...
*/
const BAS_xpath_get_first_xml = async (text, xpath_query, shutdownAfterError) => await f("BAS_xpath_get_first_xml", { text, xpath_query, shutdownAfterError })
...
*/
const BAS_xpath_get_xml_list = async (text, xpath_query) => await f("BAS_xpath_get_xml_list", { text, xpath_query })
...
*/
const BAS_xpath_get_first_text = async (text, xpath_query, shutdownAfterError) => await f("BAS_xpath_get_first_text", { text, xpath_query, shutdownAfterError })
...
*/
const BAS_xpath_get_text_list = async (text, xpath_query) => await f("BAS_xpath_get_text_list", { text, xpath_query })
...
*/
const BAS_xpath_get_count = async (text, xpath_query) => await f("BAS_xpath_get_count", { text, xpath_query })
...
*/
const BAS_xpath_exists = async (text, xpath_query) => await f("BAS_xpath_exists", { text, xpath_query })

return {	BAS_xpath_get_first_xml,
...
module.exports = get_xpath_functions