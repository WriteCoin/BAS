const get_resources_functions = (f) => {
	/**
* Создать Ресурс
...
*/
const BAS_create_resource = async (
name, 
successes, 
fails, 
simultaneous, 
...
*/
const BAS_delete_resource = async (name, instantly) => await f("BAS_delete_resource", { name, instantly })
...
*/
const BAS_resource_add = async (name, data, onlyAdd, instantly) => await f("BAS_resource_add", { name, data, onlyAdd, instantly })
...
*/
const BAS_get_resource_location = async (name) => await f("BAS_get_resource_location", { name })
...
["line1","line2","line3"]
*/
const BAS_resource_as_list = async (name) => await f("BAS_resource_as_list", { name })
...
*/
const BAS_list_to_resource = async (name, list) => await f("BAS_list_to_resource", { name, list })
...
*/
const BAS_reload_resource = async (name) => await f("BAS_reload_resource", { name })
...
*/
const BAS_resource_length = async (name) => await f("BAS_resource_length", { name })

return {	BAS_create_resource,
	BAS_delete_resource,
	BAS_resource_add,
...
module.exports = get_resources_functions